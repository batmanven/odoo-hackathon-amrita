...
import { Search, SlidersHorizontal, Plus, MoreVertical, Calendar, MapPin, ArrowRight } from 'lucide-react'
...
function TripSection({ title, trips }: { title: string; trips: TripWithCount[] }) {
            ...
            <div className="flex-1 p-6 md:p-8 flex flex-col justify-between">
              ...
              <div className="mt-8 flex items-center justify-end">
                ...
                <Button asChild className="rounded-2xl px-6 py-6 font-bold group/btn shadow-md hover:shadow-lg transition-all cursor-pointer">
                  <Link href={`/dashboard/trips/${trip.id}`} className="flex items-center gap-2">
                    View Details
    ...
    <div className="max-w-6xl mx-auto space-y-12 pb-20 px-4">
      ...
      <section className="flex flex-col md:flex-row gap-4 p-2 bg-gray-50/50 rounded-3xl border border-gray-100 backdrop-blur-sm">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-12 h-14 text-base bg-white border-gray-200 rounded-2xl shadow-xs focus-visible:ring-primary cursor-text"
          />
        </div>
      ...
      {trips.length === 0 && (
        <section className="bg-white border-2 border-gray-100 border-dashed rounded-[40px] p-20 flex flex-col items-center justify-center text-center shadow-sm">
          ...
          <p className="text-gray-500 mb-10 max-w-md text-lg">You haven&apos;t created any trips yet. Start by planning your first destination!</p>
